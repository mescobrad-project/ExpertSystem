...
Revision ID: 59b029d8ea60
Revises: e41dffdf820c
Create Date: 2024-06-02 13:52:16.078286
...
revision = '59b029d8ea60'
down_revision = 'e41dffdf820c'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.add_column('new_runs', sa.Column('ws_id', sa.BOOLEAN(), autoincrement=False, nullable=True))
