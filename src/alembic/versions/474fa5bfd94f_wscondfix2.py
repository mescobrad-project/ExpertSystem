...
Revision ID: 474fa5bfd94f
Revises: fb70c1308627
Create Date: 2024-06-17 20:24:10.111700
...
revision = '474fa5bfd94f'
down_revision = 'fb70c1308627'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('new_workflow_action_conditionals', 'weight',
