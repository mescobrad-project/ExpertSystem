...
Revision ID: aca5d96e7443
Revises: 66b66fd11d6d
Create Date: 2024-05-27 14:14:38.770210
...
revision = 'aca5d96e7443'
down_revision = '66b66fd11d6d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('new_workflow_actions', sa.Column('method', sa.String(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('new_workflow_actions', 'method')
