"""Add ws id to Workflows, Runs and Files.

Revision ID: 21bf2a37d173
Revises: 4e583ecc0689
Create Date: 2023-12-12 23:27:03.133625
...
revision = '21bf2a37d173'
down_revision = '4e583ecc0689'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('files', sa.Column('ws_id', sa.Integer(), nullable=True))
    ...
    op.add_column('runs', sa.Column('ws_id', sa.Integer(), nullable=True))
    ...
    op.add_column('workflows', sa.Column('ws_id', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('workflows', 'ws_id')
