...
Revision ID: 192be5573dbb
Revises: 21bf2a37d173
Create Date: 2023-12-15 12:09:49.481131
...
revision = '192be5573dbb'
down_revision = '21bf2a37d173'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('files', sa.Column('search', sa.String(), nullable=True))
    op.add_column('files', sa.Column('info', sa.JSON(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('files', 'info')
    op.drop_column('files', 'search')
    # ### end Alembic commands ###
