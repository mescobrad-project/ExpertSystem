...
Revision ID: fb70c1308627
Revises: 149f67ff5361
Create Date: 2024-06-17 18:05:22.545672
...
revision = 'fb70c1308627'
down_revision = '149f67ff5361'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('new_workflow_action_conditionals', sa.Column('condition', sa.String(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('new_workflow_action_conditionals', 'condition')
