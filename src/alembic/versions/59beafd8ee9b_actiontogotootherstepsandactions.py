"""ActionToGoToOtherStepsAndActions

Revision ID: 59beafd8ee9b
Revises: 51e3d799b2fa
Create Date: 2024-05-22 15:54:49.110687
...
revision = '59beafd8ee9b'
down_revision = '51e3d799b2fa'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('new_workflow_actions', sa.Column('gotostep', sa.String(), nullable=True))
    op.add_column('new_workflow_actions', sa.Column('gotoaction', sa.String(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('new_workflow_actions', 'gotoaction')
    op.drop_column('new_workflow_actions', 'gotostep')
